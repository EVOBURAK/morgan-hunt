-- =================================================================================
-- 💎 MORGAN HUB V5.0 (OFFICIAL RELEASE - ULTIMATE EDITION) 💎
-- =================================================================================
...
-- 💎 AÇILIŞ ANİMASYONU (INTRO SCREEN)
...
LoadingSub.Text = "Sistemler ve Şans Motoru Yükleniyor..."
...
task.spawn(function()
    local tweenInfo = TweenInfo.new(2.0, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
    local tween = TweenService:Create(BarFill, tweenInfo, {Size = UDim2.new(1, 0, 1, 0)})
    tween:Play()
    tween.Completed:Wait()
    
    LoadingSub.Text = "Yüklendi!"
    task.wait(0.3)
...
-- =============================================================
-- AUTO FARM ENGINE (WORLD 1 & LEVEL ADAPTIVE)
-- =============================================================
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Text = "Orijinal sistemler yüklendi ve aktifleştirildi!",
    Duration = 4
})
